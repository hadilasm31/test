...
class LamitiShop {
    constructor() {
        ...
        this.isAdmin = false;
        this.categories = ['femmes', 'hommes', 'accessoires'];
        this.subcategories = {
    ...
    addCategory(categoryName, subcategories = []) {
        if (!this.categories.includes(categoryName)) {
            ...
            this.subcategories[categoryName] = subcategories;
            this.saveCategories();
    ...
    populateQuickViewModal(product) {
        ...
        this.currentQuickViewProduct = product.id;
    }
    ...
    addToCartFromQuickView() {
        ...
        if (this.addToCart(this.currentQuickViewProduct, 1, size, color)) {
            this.closeQuickView();
        }
    }
    ...
    notifyDataChange() {
        ...
        const event = new CustomEvent('shopDataUpdate', {
            detail: { products: this.products, orders: this.orders }
        });
